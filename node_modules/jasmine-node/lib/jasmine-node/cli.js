...
function help(){
  ...
  , '  --runWithRequireJs - loads all spec using requirejs instead of node\'s native require method'
  , '  --requireJsSetup   - file run before spec to include and configure RequireJS'
